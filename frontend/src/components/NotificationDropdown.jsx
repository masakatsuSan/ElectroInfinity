...
export default function NotificationDropdown({ onClose }) {
  ...
  return (
    <div className="absolute top-full right-0 md:left-auto md:right-0 left-1/2 -translate-x-1/2 md:translate-x-0 mt-2 w-[360px] max-w-[calc(100vw-2rem)] bg-white border border-hairline rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] z-50 overflow-hidden">
