...
export default function NotificationDropdown({ onClose }) {
  ...
  return (
    <div
      className="absolute top-full right-0 mt-2 w-[22rem] sm:w-[24rem] max-w-[calc(100vw-1rem)] bg-white border border-hairline rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] z-[60] overflow-hidden"
