...
export default function AdminProfile() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] pt-0">
      <ProfileHeader
        profile={{
          ...form,
          _id: user?._id,
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-12 pb-20">
        {/* Tabs */}
        <div className="flex gap-2 mb-8 overflow-x-auto p-1 bg-white border border-divider-soft rounded-md w-max max-w-full">
          {TABS.map((tab) => (
            <button
              ...
              className={`font-sans text-[13px] font-medium uppercase tracking-[0.04em] px-5 py-2.5 rounded-md transition-all whitespace-nowrap flex items-center gap-2 ${
                activeTab === tab.id
