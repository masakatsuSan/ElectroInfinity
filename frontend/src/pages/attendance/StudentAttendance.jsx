...
export default function StudentAttendance() {
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink pt-[48px] pb-16">
      ...
      <div className="max-w-6xl px-6 lg:px-10 py-8 lg:py-12 mx-auto space-y-8">
        {/* Header */}
        ...
        <div className="grid grid-cols-1 gap-6 lg:gap-8">
          ...
          <div className="space-y-8 lg:col-span-4">
            ...
            {/* Active session card */}
            {activeSession ? (
              <div className="p-6 lg:p-8 space-y-3 border shadow-sm border-green-500/30 bg-green-500/5 rounded-2xl">
